...
\begin{center}
\HRule \\[0.4cm]
{ \bfseries Ejercicios en clase, 11}\\ % Title of your document
\HRule \\[0.4cm]
\end{center}
...
\end{enumerate} % Problema 6.27 de Chang
 ...
 \item \textit{(Chang 6.38)} Una persona calent\'o agua, para hacer t\'e, en una botella cerrada en un horno de microondas. Despu\'es de sacar la botella del horno, agreg\'o una bolsa de t\'e al agua caliente. Para su sorpresa, el agua comenz\'o a hervir violentamente. Explique este fen\'omeno. % Problema 6.38 de Chang
...
Calcule el valor de $\Delta_{vap}\bar{H}$ del mercurio. % Problema 6.17 de Chang
 ...
 \item \textit{(Chang 6.26)} El punto normal de ebullici\'on del etanol es de $78.3\celsius$ y su entalp\'ia molar de vaporizaci\'on es de $39.3\;\mbox{kJ}\cdot\mbox{mol}^{-1}$. ?`Cu\'al es su presi\'on de vapor a $30\celsius$? % Problema 6.26 de Chang
