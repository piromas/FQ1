...
\begin{center}
\HRule \\[0.4cm]
{ \bfseries Ejercicios en clase, 14}\\ % Title of your document
\HRule \\[0.4cm]
\end{center}
...
bajo las condiciones anteriores? Si no est\'a en equilibrio, ?`en qu\'e direcci\'on va a proceder para alcanzar el equilibrio? % Problema 12-21
...
Las presiones de vapor en equilibrio del $\mbox{CO}_2$ son $22.6\;\mbox{mmHg}$ a $700\,\celsius$ y de $1\,829\;\mbox{mmHg}$ a $950\,\celsius$. Calcular la entalp\'ia est\'andar de la reacci\'on. % Problema 9.8 de Chang
